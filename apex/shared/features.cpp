...
//
static void features::has_target_event(QWORD local_player, QWORD target_player, float fov, vec3 bone)
{
#ifndef __linux__
...
static vec3 features::get_target_angle(QWORD local_player, QWORD target_player, vec3 position)
{
	vec3 angle{};
...
static void features::get_best_target(QWORD local_player, QWORD *target)
{
